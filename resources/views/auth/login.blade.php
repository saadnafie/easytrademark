...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="login center-block">
                        <div class="myCtn">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="text-center mt-3">{{ trans('auth.login') }}</h2>
                                    <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div>
                                                <svg class="mySVG" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g class="mouth">
                                                        ...
                                                        <path style="display: block;" class="mouthSmallBG"
                                                              fill="#617E92"
                                                              d="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z"/>
                                                        <path style="display: block;" class="mouthMediumBG"
                                                              d="M95,104.2c-4.5,0-8.2-3.7-8.2-8.2v-2c0-1.2,1-2.2,2.2-2.2h22c1.2,0,2.2,1,2.2,2.2v2 c0,4.5-3.7,8.2-8.2,8.2H95z"/>
                                                        <path style="display: block;" class="mouthLargeBG"
                                                        ...
                                                        <g clip-path="url(#mouthMask)">
                                                            <g class="tongue">
                                                                ...
                                                                <ellipse class="tongueHighlight" cx="100" cy="100.5"
                                                                         rx="3" ry="1.5" opacity=".1" fill="#fff"/>
                                                            </g>
                                                        </g>
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <input id="email"
                                                       ...
                                                       required
                                                       autocomplete="off">
                                                <small class="my_place helper helper1" style="top:-6px">{{ trans('auth.email') }}</small>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <input id="password"
                                                       ...
                                                       required
                                                       autocomplete="off">
                                                <small class="my_place">{{ trans('auth.password') }} </small>
                                            </label>
                                        ...
                                        <div class="form-group mt-4 text-center">
                                            <a href="{{ route('register') }}"> <span class="forgot">{{ trans('auth.dont-have-an-account') }}</span></a>
                                        </div>
                                        @if (Route::has('password.request'))
                                            <div class="form-group mt-4 text-center">
                                                <span class="forgot"><a href="{{ route('password.request') }}">{{ trans('auth.forgot-password') }}</a></span>
                                            </div>
                                        @endif
                                    </form>
                                </div>
    ...
    <script>
        var email = document.querySelector('#email'), password = document.querySelector('#password'),
            mySVG = document.querySelector('.svgContainer'), armL = document.querySelector('.armL'),
            armR = document.querySelector('.armR'), eyeL = document.querySelector('.eyeL'),
            eyeR = document.querySelector('.eyeR'), nose = document.querySelector('.nose'),
            mouth = document.querySelector('.mouth'), mouthBG = document.querySelector('.mouthBG'),
            ...
            mouthOutline = document.querySelector('.mouthOutline'), tooth = document.querySelector('.tooth'),
            tongue = document.querySelector('.tongue'), chin = document.querySelector('.chin'),
            face = document.querySelector('.face'), eyebrow = document.querySelector('.eyebrow'),
            outerEarL = document.querySelector('.earL .outerEar'),
            outerEarR = document.querySelector('.earR .outerEar'), earHairL = document.querySelector('.earL .earHair'),
            earHairR = document.querySelector('.earR .earHair'), hair = document.querySelector('.hair');
        var caretPos, curEmailIndex, screenCenter, svgCoords, eyeMaxHorizD = 20, eyeMaxVertD = 10, noseMaxHorizD = 23,
