                ...
                <table class="table" class="text-center">
                    ...
                    <div class="search ">
                        <form action="{{ route('trademark-search') }}" method="GET" class="text-right">
                            From : <input type="date" name="searchFrom" class="my_form-control " data-date="" data-date-format="DD/MM/YYYY" value="{{$searchFrom}}">
                            To : <input type="date" name="searchTo" class="my_form-control " data-date="" data-date-format="DD/MM/YYYY" value="{{$searchTo}}">
