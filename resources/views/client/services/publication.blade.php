        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="steper">
                        <div class="card">
                            <form id="msform" role="form" method="post" action="{{route('publicationStore')}}"
                                ...
                                <fieldset>
                                    <h2 id="heading">Trademark Publication
                                    </h2>
                                    <hr>
                                    <div class="form-card">
                                                ...
                                                <div>
                                                    ...
                                                    <span>
                                                          <select name="package" id="" class="my_form-control"
                                                                  ...
                                                                  <option
                                                                      value="{{$package->id}}">{{$package->package->package}} </option>
                                                              @endforeach
                                                          </select>
                                                    </span>
                                                </div>
