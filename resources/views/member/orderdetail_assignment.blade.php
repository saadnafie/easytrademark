                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="email" type="text" class="form-control" name="email"
                                           value="{{$order_details->trademark_assignment->assignor_name}}" disabled>
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon">Assignor Address</span>
                                    <input id="email" type="text" class="form-control" name="email"
                                           value="{{$order_details->trademark_assignment->assignor_address}}" disabled>
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon">Assignee Name</span>
                                    <input id="email" type="text" class="form-control" name="email"
                                           value="{{$order_details->trademark_assignment->assignee_name}}" disabled>
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon">Assignee Address</span>
                                    <input id="email" type="text" class="form-control" name="email"
                                           value="{{$order_details->trademark_assignment->assignee_address}}" disabled>
                                </div>
                                <br>
                                <div class="input-group">
