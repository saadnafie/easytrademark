                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon">Old Address</span>
                                    <input id="email" type="text" class="form-control" name="email"
                                           value="{{$order_details->tm_address_change->old_address}}" disabled>
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon">New Address</span>
                                    <input id="email" type="text" class="form-control" name="email"
                                           value="{{$order_details->tm_address_change->new_address}}" disabled>
                                </div>
                                <br>
                                <div class="input-group">
